...
author: "Rebecca Folmer Schade & Sophia "
date: "2021-05-11 updated `r format(Sys.time(), '%B %d, %Y')`"
...
In this script, data on LGBT+ friendly amenities in the European Economic Area (EEA) and Switzerland is gathered from Open Street Maps and cleaned for use in the Leaflet visualisation.
...
As the lines and multypoligons were unexpected, they are saved separetly for now. 
